...
set_input_delay   -max  $CORE_INPUT_DELAY            -clock clk   [get_ports rst_n] ;  # set_up time check
set_input_delay   -min  $CORE_INPUT_DELAY            -clock clk   [get_ports rst_n] ;  # hold   time check

set_input_delay   -max  $CORE_INPUT_DELAY            -clock clk   [get_ports Rt_write] ;  # set_up time check
set_input_delay   -min  $CORE_INPUT_DELAY            -clock clk   [get_ports Rt_write] ;  # hold   time check

set_input_delay   -max  $CORE_INPUT_DELAY            -clock clk   [get_ports to_refresh] ;  # set_up time check
set_input_delay   -min  $CORE_INPUT_DELAY            -clock clk   [get_ports to_refresh] ;  # hold   time check

set_input_delay   -max  $CORE_INPUT_DELAY            -clock clk   [get_ports Ra] ;  # set_up time check
set_input_delay   -min  $CORE_INPUT_DELAY            -clock clk   [get_ports Ra] ;  # hold   time check

set_output_delay   -max  $OUTPUT_DLY            -clock clk   [get_ports dref] ;  # set_up time check
set_output_delay   -min  $OUTPUT_DLY            -clock clk   [get_ports dref] ;  # hold   time check
