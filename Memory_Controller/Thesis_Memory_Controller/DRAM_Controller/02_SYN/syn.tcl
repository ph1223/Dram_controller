...
# CLK
set_input_delay   -max  $INPUT_DLY            -clock clk   [get_ports command_valid] ;  # set_up time check
set_input_delay   -min  $INPUT_DLY            -clock clk   [get_ports command_valid] ;  # hold   time check
